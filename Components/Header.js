...
const Header = () => {
    ...
    <div className="flex justify-between px-44 shadow-md">
        <Link to={"/"}><img data-testid="logo" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRYwIUy1t2Lz3UzqmOIhgjaYxb7uAL7zIg2hVo6QEyLHZ3-rl_e6haXHtQYjFK1ORyCDBw&usqp=CAU" className="w-28 hover:animate-pulse"/></Link>
        <ul className="flex my-10 ">
            ...
            <Link to={"/cart"}><li className="px-2 font-bold text-lg hover:text-orange-500">Cart <span className="bg-green-500 p-1" data-testid="cart">{cartItems.length}</span></li></Link>
        </ul>
